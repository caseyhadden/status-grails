            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.entry.label" default="Entry" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${taskInstance?.entry}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.user.label" default="User" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${taskInstance?.user?.id}">${taskInstance?.user?.encodeAsHTML()}</g:link></td>
